// 44.3  write a java program which accepts directory name and write data of all files into newly created file named as "Marvellous.txt".

import java.lang.*;
import java.util.*;
import java.io.*;

class Assignment_44_3
{
